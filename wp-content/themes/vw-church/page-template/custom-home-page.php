                ...
                <div class="carousel-caption">
                  <div class="inner_carousel">
                    ...
                    <div class="more-btn my-3 my-lg-4 my-md-4 wow slideInRight delay-1000" data-wow-duration="2s">
                      <a href="<?php echo esc_url(get_theme_mod('vw_church_top_button_url',false));?>"><?php echo esc_html(get_theme_mod('vw_church_slider_button_text',__('Read More','vw-church')));?><span class="screen-reader-text"><?php echo esc_html('Read More','vw-church');?></span></a>
                    </div>
                  </div>
                </div>
              </div>
