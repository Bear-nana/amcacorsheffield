			...
			<div class="responsive-preview-actions">
				<div class="site-action-buttons-wrap">
					<div class="responsive-sites-import-template-action site-action-buttons-right">
						...
						#>
										<p style="color: #FF0000; font-size: 12px; margin-right: 14px;"><span class="eicon-warning-full"></span>This Pro Template requires REA plugin. <a style="color: #FF0000; text-decoration: underline" href="{{responsiveElementorSites.getREAURL}}" target="_blank">Read More.</a></p>
						<#
									}
								} else {
									if ( responsiveElementorSites.isREAActivated ) {
						...
						#>
										<p style="color: #FF0000; font-size: 12px; margin-right: 14px;"><span class="eicon-warning-full"></span>This Pro Block requires REA plugin. <a style="color: #FF0000; text-decoration: underline" href="{{responsiveElementorSites.getREAURL}}" target="_blank">Read More.</a></p>
						<#
									}
								} else {
									if ( responsiveElementorSites.isREAActivated ) {
